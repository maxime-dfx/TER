...
public:
    ...
    void setDamageState(const std::vector<double>& d) { damageState = d; }
    ...
    DetailedResults computeEffectiveProperties(LoadCase lc, double appliedStrain) const;
    
    // Évalue les critères de rupture et met à jour le vecteur d'endommagement
    void updateDamageState(std::vector<double>& current_damage) const;
};
#endif